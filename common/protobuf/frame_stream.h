...
// map.h(365,46): warning C4244: 'argument': conversion from 'const uint64_t' to 'size_t', possible loss of data
// repeated_field.h(546, 44) : warning C4189 : 'elem' : local variable is initialized but not referenced
#pragma warning(disable: 4100 4127 4512 4996 5054 4244 4189)
