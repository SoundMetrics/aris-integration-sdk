...
namespace SoundMetrics.Data.Filters.UT
{
    ...
    public class UnweightedMedianFilterTests
    {
        ...
        public void TestNoise()
        {
            ...
            // Median filters aren't magic, but they do have some staying power for
            // keeping a good signal.
            var cases = new[]
            {
                new { Input = 10, IsBufferFilled = false, ExpectedValue = 10 },
                new { Input = 10, IsBufferFilled = false, ExpectedValue = 10 },
                new { Input = 10, IsBufferFilled = false, ExpectedValue = 10 },
                new { Input = 10, IsBufferFilled = false, ExpectedValue = 10 },
                new { Input = 10, IsBufferFilled = true, ExpectedValue = 10 },

                new { Input = -100, IsBufferFilled = true, ExpectedValue = 10 },
                new { Input = -100, IsBufferFilled = true, ExpectedValue = 10 },
                new { Input = +100, IsBufferFilled = true, ExpectedValue = 10 },
                new { Input = +100, IsBufferFilled = true, ExpectedValue = 10 },
            };
